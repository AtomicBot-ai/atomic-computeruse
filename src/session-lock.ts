...
let configuredLockDir: string | undefined;

export function configureLockDir(dir: string): void {
  configuredLockDir = dir;
}

function getLockDir(): string {
  return configuredLockDir ?? join(homedir(), ".atomic-computeruse");
}
